...
class Admin
{
    ...
    /**
     * @deprecated and will be removed in OpenDxp 12
     */
    public static function getMaintenanceModeFile(): string
    {
        return OPENDXP_CONFIGURATION_DIRECTORY . '/maintenance.php';
    }
    ...
    {
        return OPENDXP_CONFIGURATION_DIRECTORY . '/maintenance-schedule-login.php';
    }
    ...
    {
        if (empty($sessionId)) {
            $sessionId = OpenDxp::getContainer()->get('request_stack')->getSession()->getId();
        }
        ...
        if (is_file($file)) {
            trigger_deprecation(
                ...
                sprintf(
                    ...
                    \tThe maintenance mode schedule on login will not work in OpenDxp 12", $file)
            );
            $conf = include($file);
    ...
    public static function scheduleMaintenanceModeOnLogin(): void
    {
        ...
        OpenDxp::getEventDispatcher()->dispatch(new GenericEvent(), SystemEvents::MAINTENANCE_MODE_SCHEDULE_LOGIN);
    }
    ...
    public static function unscheduleMaintenanceModeOnLogin(): void
    {
        ...
        OpenDxp::getEventDispatcher()->dispatch(new GenericEvent(), SystemEvents::MAINTENANCE_MODE_UNSCHEDULE_LOGIN);
    }
