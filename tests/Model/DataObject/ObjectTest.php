...
class ObjectTest extends ModelTestCase
{
    ...
    public function testEmptyValuesAsNullApi(): void
    {
        ...
        $iqv = new \OpenDxp\Model\DataObject\Data\InputQuantityValue('1', Unit::getByAbbreviation('km')->getId());
        ...
        $object->setWysiwyg('');
        $object->setPassword('');
        $iqv = new \OpenDxp\Model\DataObject\Data\InputQuantityValue('', '');
        $object->setInputQuantityValue($iqv);
        $object->save();
    ...
    public function testEmptyValuesAsNullBackend(): void
    {
        ...
        //check empty strings
        $dataType = new \OpenDxp\Model\DataObject\ClassDefinition\Data\Input();
        $value = $dataType->getDataFromEditmode('', $object);
        $this->assertNull($value);

        $dataType = new \OpenDxp\Model\DataObject\ClassDefinition\Data\Textarea();
        $value = $dataType->getDataFromEditmode('', $object);
        $this->assertNull($value);

        $dataType = new \OpenDxp\Model\DataObject\ClassDefinition\Data\Wysiwyg();
        $value = $dataType->getDataFromEditmode('', $object);
        $this->assertNull($value);

        $dataType = new \OpenDxp\Model\DataObject\ClassDefinition\Data\Password();
        $value = $dataType->getDataFromEditmode('', $object);
        $this->assertNull($value);

        $dataType = new \OpenDxp\Model\DataObject\ClassDefinition\Data\InputQuantityValue();
        $iqv = ['value' => '', 'unit' => ''];
