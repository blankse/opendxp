...
namespace OpenDxp\Tests\Model\DataType\ClassificationStore;
...
use OpenDxp\Model\DataObject\Data\EncryptedField;
...
class GeneralTest extends AbstractClassificationStoreTest
{
    ...
    public function testBasics(): void
    {
        ...
        $o = new \OpenDxp\Model\DataObject\Csstore();
        $o->setParentId(1);
        $o->setKey('testobject');
        $o->setPublished(true);
        ...
        $this->assertTrue($csField instanceof \OpenDxp\Model\DataObject\Classificationstore, 'type mismatch');
        ...
        foreach ($validLanguages as $validLanguage) {
            foreach ($keyNames as $keyName) {
                $keyConfig = \OpenDxp\Model\DataObject\Classificationstore\KeyConfig::getByName($keyName, $store->getId());
                $idx++;
        ...
        $o = \OpenDxp\Model\DataObject\Csstore::getById($o->getId());
        $csField = $o->getCsstore();
        ...
        $keyConfig = \OpenDxp\Model\DataObject\Classificationstore\KeyConfig::getByName('input', $store->getId());
    ...
    public function testBooleanSelect(): void
    {
        ...
        $groupConfig = Classificationstore\GroupConfig::getByName('testgroup1');
        $keyConfig = \OpenDxp\Model\DataObject\Classificationstore\KeyConfig::getByName('booleanSelect', $store->getId());

        $originalValue = true;
        $csField->setLocalizedKeyValue($groupConfig->getId(), $keyConfig->getId(), $originalValue);
        $o->save();
        $o = \OpenDxp\Model\DataObject\Csstore::getById($o->getId(), ['force' => true]);
    ...
    public function testCheckbox(): void
    {
        ...
        $groupConfig = Classificationstore\GroupConfig::getByName('testgroup1');
        $keyConfig = \OpenDxp\Model\DataObject\Classificationstore\KeyConfig::getByName('checkbox', $store->getId());
    ...
    public function testClassificationStoreQuantityValue(): void
    {
        ...
        $keyConfig = \OpenDxp\Model\DataObject\Classificationstore\KeyConfig::getByName('qValue', $store->getId());
        $value = new \OpenDxp\Model\DataObject\Data\QuantityValue(123, '1');
        ...
        $o = \OpenDxp\Model\DataObject\Csstore::getById($o->getId());
        /** @var \OpenDxp\Model\DataObject\Data\QuantityValue $value1 */
        ...
        //clear value
        $value = new \OpenDxp\Model\DataObject\Data\QuantityValue(null, '1');
        ...
        $value = new \OpenDxp\Model\DataObject\Data\QuantityValue(null, null);
        $o->getCsstore()->setLocalizedKeyValue($groupConfig->getId(), $keyConfig->getId(), $value);
        $o->save();
    ...
    public function testCountry(): void
    {
        ...
        $groupConfig = Classificationstore\GroupConfig::getByName('testgroup1');
        $keyConfig = \OpenDxp\Model\DataObject\Classificationstore\KeyConfig::getByName('country', $store->getId());
    ...
    public function testCountrymultiselect(): void
    {
        ...
        $groupConfig = Classificationstore\GroupConfig::getByName('testgroup1');
        $keyConfig = \OpenDxp\Model\DataObject\Classificationstore\KeyConfig::getByName('countrymultiselect', $store->getId());
    ...
    public function testDate(): void
    {
        ...
        $groupConfig = Classificationstore\GroupConfig::getByName('testgroup1');
        $keyConfig = \OpenDxp\Model\DataObject\Classificationstore\KeyConfig::getByName('date', $store->getId());
    ...
    public function testDatetime(): void
    {
        ...
        $groupConfig = Classificationstore\GroupConfig::getByName('testgroup1');
        $keyConfig = \OpenDxp\Model\DataObject\Classificationstore\KeyConfig::getByName('datetime', $store->getId());
    ...
    public function testEncryptedField(): void
    {
        ...
        $groupConfig = Classificationstore\GroupConfig::getByName('testgroup1');
        $keyConfig = \OpenDxp\Model\DataObject\Classificationstore\KeyConfig::getByName('encryptedField', $store->getId());
    ...
    public function testInputQuantityValue(): void
    {
        ...
        $groupConfig = Classificationstore\GroupConfig::getByName('testgroup1');
        $keyConfig = \OpenDxp\Model\DataObject\Classificationstore\KeyConfig::getByName('inputQuantityValue', $store->getId());
    ...
    public function testLanguage(): void
    {
        ...
        $groupConfig = Classificationstore\GroupConfig::getByName('testgroup1');
        $keyConfig = \OpenDxp\Model\DataObject\Classificationstore\KeyConfig::getByName('language', $store->getId());
    ...
    public function testLanguagemultiselect(): void
    {
        ...
        $groupConfig = Classificationstore\GroupConfig::getByName('testgroup1');
        $keyConfig = \OpenDxp\Model\DataObject\Classificationstore\KeyConfig::getByName('languagemultiselect', $store->getId());
    ...
    public function testMultiselect(): void
    {
        ...
        $groupConfig = Classificationstore\GroupConfig::getByName('testgroup1');
        $keyConfig = \OpenDxp\Model\DataObject\Classificationstore\KeyConfig::getByName('multiselect', $store->getId());
    ...
    public function testNumeric(): void
    {
        ...
        $groupConfig = Classificationstore\GroupConfig::getByName('testgroup1');
        $keyConfig = \OpenDxp\Model\DataObject\Classificationstore\KeyConfig::getByName('numeric', $store->getId());
    ...
    public function testQuantityValue(): void
    {
        ...
        $groupConfig = Classificationstore\GroupConfig::getByName('testgroup1');
        $keyConfig = \OpenDxp\Model\DataObject\Classificationstore\KeyConfig::getByName('quantityValue', $store->getId());
    ...
    public function testRgbaColor(): void
    {
        ...
        $groupConfig = Classificationstore\GroupConfig::getByName('testgroup1');
        $keyConfig = \OpenDxp\Model\DataObject\Classificationstore\KeyConfig::getByName('rgbaColor', $store->getId());
    ...
    public function testSelect(): void
    {
        ...
        $groupConfig = Classificationstore\GroupConfig::getByName('testgroup1');
        $keyConfig = \OpenDxp\Model\DataObject\Classificationstore\KeyConfig::getByName('select', $store->getId());
    ...
    public function testSlider(): void
    {
        ...
        $groupConfig = Classificationstore\GroupConfig::getByName('testgroup1');
        $keyConfig = \OpenDxp\Model\DataObject\Classificationstore\KeyConfig::getByName('slider', $store->getId());
    ...
    public function testTable(): void
    {
        ...
        $groupConfig = Classificationstore\GroupConfig::getByName('testgroup1');
        $keyConfig = \OpenDxp\Model\DataObject\Classificationstore\KeyConfig::getByName('table', $store->getId());
    ...
    public function testTextarea(): void
    {
        ...
        $groupConfig = Classificationstore\GroupConfig::getByName('testgroup1');
        $keyConfig = \OpenDxp\Model\DataObject\Classificationstore\KeyConfig::getByName('textarea', $store->getId());
    ...
    public function testTime(): void
    {
        ...
        $groupConfig = Classificationstore\GroupConfig::getByName('testgroup1');
        $keyConfig = \OpenDxp\Model\DataObject\Classificationstore\KeyConfig::getByName('time', $store->getId());
    ...
    public function testUser(): void
    {
        ...
        $groupConfig = Classificationstore\GroupConfig::getByName('testgroup1');
        $keyConfig = \OpenDxp\Model\DataObject\Classificationstore\KeyConfig::getByName('user', $store->getId());
    ...
    public function testWysiwyg(): void
    {
        ...
        $groupConfig = Classificationstore\GroupConfig::getByName('testgroup1');
        $keyConfig = \OpenDxp\Model\DataObject\Classificationstore\KeyConfig::getByName('wysiwyg', $store->getId());
