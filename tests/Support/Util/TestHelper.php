...
namespace OpenDxp\Tests\Support\Util;
...
use OpenDxp\Model\DataObject as ObjectModel;
...
class TestHelper
{
    ...
    {
        return defined('OPENDXP_TEST_DB_INITIALIZED') ? OPENDXP_TEST_DB_INITIALIZED : false;
    }
    ...
    public static function createEmptyDocument(?string $keyPrefix = '', bool $save = true, bool $publish = true, string $type = '\\OpenDxp\\Model\\Document\\Page'): Document
    {
        if (null === $keyPrefix) {
            $keyPrefix = '';
        }
