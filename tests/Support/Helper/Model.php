...
class Model extends AbstractDefinitionHelper
{
     ...
     */
    public function setupOpenDxpClass_Csstore(array $params = [], string $name = 'csstore', string $filename = 'classificationstore.json'): ?DataObject\ClassDefinitionInterface
    {
        /** @var ClassManager $cm */
        $cm = $this->getClassManager();

        if (!$class = $cm->getClass($name)) {
            $root = new \OpenDxp\Model\DataObject\ClassDefinition\Layout\Panel('root');
            $panel = (new \OpenDxp\Model\DataObject\ClassDefinition\Layout\Panel())->setName('MyLayout');
            $rootPanel = (new \OpenDxp\Model\DataObject\ClassDefinition\Layout\Tabpanel())->setName('Layout');
     ...
     * @throws Exception
     */
    public function setupOpenDxpClass_LazyLoading(string $name = 'LazyLoading', string $filename = 'lazyloading/class_LazyLoading_export.json'): ?DataObject\ClassDefinitionInterface
    {
        /** @var ClassManager $cm */
        $cm = $this->getClassManager();
        ...
        if (!$class = $cm->getClass($name)) {
            ...
            $lFields = new \OpenDxp\Model\DataObject\ClassDefinition\Data\Localizedfields();
     ...
     * @throws Exception
     */
    public function setupOpenDxpClass_RelationTest(string $name = 'RelationTest', string $filename = 'relations/class_RelationTest_export.json'): ?DataObject\ClassDefinitionInterface
    {
        /** @var ClassManager $cm */
        $cm = $this->getClassManager();
     ...
     * @throws Exception
     */
    public function setupOpenDxpClass_MultipleAssignments(string $name = 'MultipleAssignments', string $filename = 'relations/class_MultipleAssignments_export.json'): ?DataObject\ClassDefinitionInterface
    {
        /** @var ClassManager $cm */
        $cm = $this->getClassManager();
     ...
     * @throws Exception
     */
    public function setupOpenDxpClass_Block(string $name = 'unittestBlock', string $filename = 'block-import.json'): ?DataObject\ClassDefinitionInterface
    {
        /** @var ClassManager $cm */
        $cm = $this->getClassManager();
     ...
     * @throws Exception
     */
    public function setupOpenDxpClass_Link(string $name = 'unittestLink', string $filename = 'link-import.json'): ?DataObject\ClassDefinitionInterface
    {
        /** @var ClassManager $cm */
        $cm = $this->getClassManager();
     ...
     * @throws Exception
     */
    public function setupOpenDxpClass_Unittest(string $name = 'unittest', string $filename = 'class-import.json'): ?DataObject\ClassDefinitionInterface
    {
        /** @var ClassManager $cm */
        $cm = $this->getClassManager();
        ...
        if (!$class = $cm->getClass($name)) {
            ...
            $calculatedValueExpressionConstant->setCalculatorExpression("constant('OPENDXP_PROJECT_ROOT')");
     ...
     * @throws Exception
     */
    public function setupOpenDxpClass_Inheritance(string $name = 'inheritance', string $filename = 'inheritance.json'): ?DataObject\ClassDefinitionInterface
    {
        /** @var ClassManager $cm */
        $cm = $this->getClassManager();
        ...
        if (!$class = $cm->getClass($name)) {
            ...
            $otherPanel = (new \OpenDxp\Model\DataObject\ClassDefinition\Layout\Panel())->setName('Layout');
    ...
    public function initializeDefinitions(): void
    {
        ...
        $this->setupOpenDxpClass_RelationTest();
