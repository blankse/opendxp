...
In the system settings (*Settings* > *System Settings*) system-wide settings for OpenDXP can be made. Changes should 
...
## Debug
Debugging settings for OpenDXP, like Debug email addresses, Debug admin translations.

## Website
System settings about the CMS part of OpenDXP.
