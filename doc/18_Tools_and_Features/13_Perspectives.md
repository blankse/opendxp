...
You can create or edit perspectives and custom views within the OpenDXP backend UI using the [perspective editor](/docs/platform/Perspective_Editor/) bundle.
...
I changed the number of elements rendered in the main OpenDXP menu.
