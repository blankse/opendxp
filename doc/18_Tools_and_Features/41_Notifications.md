...
For accessing and working with tags via API, take a look into `OpenDxp\Model\Notification\Service\NotificationService`.
...
It is done in the `opendxp_admin` configuration in the `notifications` section.
