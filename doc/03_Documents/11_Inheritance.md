...
You can get Main document object by `getContentMainDocument` method available in `\OpenDxp\Model\Document\Page`.

```php
$document = \OpenDxp\Model\Document\Page::getById(130);
dump([
