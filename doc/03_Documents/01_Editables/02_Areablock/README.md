...
The areablock is the content construction kit for documents offered by OpenDXP.
...
```twig
{% set areaBlock = opendxp_areablock("myArea", {"manual":true}) %}
