...
```twig
{% for i in opendxp_scheduledblock("block").iterator %}
    <h2>{{ opendxp_input("blockinput") }}</h2>
...
In document preview, OpenDXP provides a time slider to get the preview for a certain time as soon as 
