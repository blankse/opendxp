...
The renderlet is a special container which is able to handle every element in OpenDXP (Documents, Assets, Objects).
...
{% if assets %}
	<div class="my-gallery">
		{% for asset in assets %}
			{% if asset is instanceof('\\OpenDxp\\Model\\Asset\\Image') %}
