...
| `imagethumbnail`        | string         | Name of the image-thumbnail, this thumbnail config is used to generate the preview image (poster image), if not specified OpenDXP tries to get the information out of the video thumbnail. see also: Video Thumbnails |
...
| `getPosterAsset()`         |                      | OpenDxp\Model\Asset                                     | Returns the assigned poster image asset                               |
