...
```twig
<div>
{{ opendxp_area("myArea", {"type": "gallery-single-images"}) }}
</div>
```
...
<?php
// load document
$document = \OpenDxp\Model\Document\Page::getByPath('/en/basic-examples/galleries');

/** @var \OpenDxp\Model\Document\Editable\Area $area */
$area = $document->getEditable('myArea');

/** @var \OpenDxp\Model\Document\Editable\Block $block */
