...
Products (stored as OpenDXP objects) are organized in a certain hierarchy and take advantage of OpenDXPs data 
...
To do so create a [Event Listener](../20_Extending_OpenDxp/11_Event_API_and_Event_Manager.md) 
...
services:
    app.event_listener.my_event_listner:
        ...
        tags:
            - { name: kernel.event_listener, event: opendxp.admin.dataobject.get.preSendData, method: selectCustomLayout }
```
...
class MyEventListener
{
    public function selectCustomLayout(GenericEvent $event): void
    {
        ...
        if ($object instanceof Product) {
            ...
            //data element that is send to OpenDXP backend UI
