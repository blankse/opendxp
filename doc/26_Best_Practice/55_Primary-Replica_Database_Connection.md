# How to Configure OpenDXP To Use a Primary/Replica Database Connection 
...
for a primary/replica server setup! Due to the extensive multi-layered, consistent and tagged caching of OpenDXP
it is necessary that OpenDXP always has access to the latest data in the database. Due to the asynchronous nature 
...
The main database connection which you have configured for OpenDXP is always the primary connection. 
