...
Every document has one single language/locale assigned. As a consequence of that, OpenDXPs best practice in terms of 
...
OpenDXP provides two additional features to support editors in translating and managing documents for several languages: 

### Localization Tool

The localization tool for OpenDXP documents is a comfort tool which supports creation and management of the same document
...
### Content Inheritance
Content inheritance is a OpenDXP feature to save duplicate data maintenance within documents. This feature is quite handy
