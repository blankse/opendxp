...
every state-of-the-art e-commerce project. With its integrated approach OpenDXP does exactly that and provides several
...
which provide a great way to integrate dynamic object (thus commerce) content to OpenDXP documents. 
...
```twig
<div class="row">
    {% for i in opendxp_block('teaserblock').iterator %}
        {{ opendxp_renderlet('productteaser', {
            controller: 'shop',
            action: 'productCell',
            width: 270,
            height: 370,
