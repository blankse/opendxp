...
In terms of sending output to the frontend, OpenDXP follows the MVC pattern. 
Therefore it is crucial to know the fundamentals about the pattern in general and 
  the specifics in combination with OpenDXP. 
...
The MVC module of OpenDXP is built on top of Symfony. If you are new to Symfony you can read about 
[controllers](https://symfony.com/doc/current/controller.html) in the Symfony manual. With this 
knowledge learning OpenDXP will be much easier and faster.
