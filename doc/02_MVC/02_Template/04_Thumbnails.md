...
When source images are stored as OpenDXP Assets (as they should be), OpenDXP can do all the optimizing work for you. 
Just use the Thumbnail functionality and let OpenDXP transform the images the way you need them. 
