...
**Note:** The `captureStart()` and `captureEnd()` methods are deprecated as of OpenDXP 1.0. Use a combination of `set` and `opendxp_head_script` to achieve the same result.
