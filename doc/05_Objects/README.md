...
Objects are the PIM part of OpenDXP and are the way to go for managing structured data within OpenDXP. Based on a class 
...
OpenDXP objects are literally objects in the sense of object oriented programming. The class definition can be defined 
...
So managing data becomes really easy. Data objects can be instantiated and filled within OpenDXP backend or within your
custom code by using the PHP API and common programming paradigms (create new instances, using getter and setter, ...).
 For saving objects just call the `save`` method and OpenDXP takes care of the rest. 
...
For all the provided backend functionality within OpenDXP have a look at the User Documentation of OpenDXP.
