...
the same way. Programmatically the values are represented by a [NumericRange](https://github.com/open-dxp/opendxp/tree/11.x/models/DataObject/Data/NumericRange.php) Object.
...
```php
$unit = new OpenDxp\Model\DataObject\QuantityValue\Unit();
...
For importing there is also a command: `opendxp:definition:import:units`
...
represented by a [QuantityValueRange](https://github.com/open-dxp/opendxp/tree/11.x/models/DataObject/Data/QuantityValueRange.php) Object.
...
$converter = $this->container->get(\OpenDxp\Model\DataObject\QuantityValue\UnitConversionService::class);
