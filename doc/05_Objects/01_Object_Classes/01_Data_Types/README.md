...
|--------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| select                   | combo box                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| user                     | combo box to select from all existing OpenDXP users (available since build 716) <br/><br/>In the user settings the object dependencies of each user are shown in the second tab panel.<br/>All objects which reference the selected user are listed in a grid view.<br/><br/>If one needs to find out which objects hold a reference to a specific user, the `OpenDxp\\Tool\\Admin::getObjectsReferencingUser($userId)` method can be used to find all referencing objects. |
...
| Name                     | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
|--------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Many-To-One Relation     | reference to a OpenDXP document, object or asset                                                                                                                                                                                                                                                                                                                                                                                                                                |
| Many-To-Many Relation    | collection of references to OpenDXP documents, objects, assets                                                                                                                                                                                                                                                                                                                                                                                                                  |
| Advanced Many-To-Many Relation | collection of references to OpenDXP documents, objects, assets with additional metadata on the relation                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Many-To-Many Object Relation | collection of OpenDXP object references                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| Advanced Many-To-One Object Relation | collection of OpenDXP object references with additional metadata on the relation                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| [Reverse Object Relation](75_Reverse_Object_Relation_Type.md) | collection of OpenDXP object references which are owned by a different object                                                                                                                                                                                                                                                                                                                                |
...
| Name                                                                                   | Description                                                                                            |
|----------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------|
| [image](./45_Image_Types.md)                                                           | drop area & preview for a OpenDXP image asset                                                          |
| [externalimage](./45_Image_Types.md)                                                   | relation to an image that is not stored in OpenDXP                                                     |
| [imageadvanced](./45_Image_Types.md#image-advanced-supporting-hotspotsmarkerscropping) | drop area & preview for a OpenDXP image asset with additional features for markers, hotspots, cropping |
| [imagegallery](./45_Image_Types.md)                                                    | collection of `Image Advanced` images                                                                  |          
| [video](./98_Video_Type.md)                                                            | drop area & preview for a OpenDXP video asset                                                          |
...
| persona                   | typed selectbox for personas defined within OpenDXP                                   |
| personas                  | typed selectbox with multiselect for personas defined within OpenDXP                  |
| [consent](./20_Consent.md) | store consent of user for something, e.g. consent for direct marketing mailing        |


The following datatypes are only available if the OpenDxpNewsletterBundle is enabled and installed:
...
All data types are wrapped in an object derived from `OpenDxp\Model\DataObject\ClassDefinition\Data`. 
...
The second column indicates the underlying data type class and the third column outlines the Description used in OpenDXP 
...
* `not editable`: Does not allow a change of this field's value in OpenDXP backend (data change can only be done 
  programmatically)
* `invisible`: The field is not visible in OpenDXP
...
A default value generator is a class which implements `\OpenDxp\Model\DataObject\ClassDefinition\DefaultValueGeneratorInterface`. This class can generate a value based on the current data of an object.
