...
OpenDxp\Model\DataObject\Data\Video Object
(
    [type] => asset
    [data] => OpenDxp\Model\Asset\Video Object
        (
            [type] => video
            [id] => 27
            ...
    ...
    [poster] => OpenDxp\Model\Asset\Image Object
        (
            [type] => image
            [id] => 284
            ...
...
if($videoData) {
    $video = new \OpenDxp\Model\Document\Editable\Video();
    $video->setConfig([
