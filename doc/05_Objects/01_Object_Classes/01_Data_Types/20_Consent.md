...
### Usage in OpenDXP Admin Backend
The consent value can be changed directly in object editor. Every time the value changes, a note with default values
is added automatically.

### Usage in PHP API
When setting consent in custom controllers or in other places, use the service `OpenDxp\DataObject\Consent\Service` 
...
<?php 
    ...
    /**
    *  @var OpenDxp\DataObject\Consent\Service $consentService
    **/
