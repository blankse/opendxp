...
- **Standard PHP class**: Provide fully qualified namespace name of class, OpenDXP will instanciate it with `new`. 
...
The arguments passed into this method is the OpenDXP object and the contextual information 
