...
To get started with OpenDXP objects, classes must be defined. 
...
To define a class, the menu `Settings` -> `Data Objects` -> `Classes` needs to be used in the OpenDXP toolbar menu. 
...
and [Class Settings](./05_Class_Settings/README.md) for further details and features of OpenDXP classes like 
