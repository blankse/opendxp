...
OpenDXP allows you to define custom icons for objects. Either, icons can be the same for all objects of a class 
...
Objects can be displayed in OpenDXP with custom icons. This makes objects distinguish themselves visually based on the 
