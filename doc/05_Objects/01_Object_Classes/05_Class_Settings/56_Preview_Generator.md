...
Providers need to implement: `\OpenDxp\Model\DataObject\ClassDefinition\PreviewGeneratorInterface`

> As of OpenDXP 10.6, a default implementation of a `PreviewGenerator` is provided. You only need to add
