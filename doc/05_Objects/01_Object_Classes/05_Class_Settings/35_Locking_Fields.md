...
OpenDXP offers the possibility to lock a field programmatically, you can call the method `setLocked()` on every 
`OpenDxp\Model\DataObject\ClassDefinition\Data` object.
