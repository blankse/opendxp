...
On class level, there are multiple additional settings and features available which influence the appearance and behaviour of OpenDXP. These can be either configured in the OpenDXP
