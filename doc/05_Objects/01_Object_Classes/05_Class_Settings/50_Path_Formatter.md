...
### Summary
* Allows you to show a user friendly "object information' instead of technical path in OpenDXP data types such as Many-To-One, Many-To-Many (Object) etc.
...
use OpenDxp\Model\DataObject\News;
