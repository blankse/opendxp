...
The DeviceDetector helper makes it easy to implement the adaptive design approach in OpenDXP. 
...
This will set the device to the specified value and OpenDXP will remember this setting using a 
cookie (name: `forceDeviceType`) till the browser session ends. 
 
 
### Caching
The OpenDXP output-cache is aware of this feature and just works as expected. 
