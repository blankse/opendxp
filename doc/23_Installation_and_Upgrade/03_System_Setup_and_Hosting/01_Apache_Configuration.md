...
All the necessary rewrite rules, which are needed for OpenDXP to work, must be defined in the `.htaccess` file on path `public/.htaccess`,
as below:
...
<VirtualHost *:443>
        ...
        <FilesMatch \.php$>
            SetHandler "proxy:unix:/var/run/php/opendxp.sock|fcgi://localhost"
        </FilesMatch>
