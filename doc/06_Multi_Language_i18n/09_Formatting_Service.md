...
OpenDXP ships a service for international formatting of numbers, currencies and date time. The service is basically a 
...
```php
<?php
$service = \OpenDxp::getContainer()->get(OpenDxp\Localization\IntlFormatter::class);
...
services:
    ...
    OpenDxp\Localization\IntlFormatter:
        calls:
