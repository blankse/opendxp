...
opendxp: 
    workflows:
        ...
        name:
            ...
            # Handles the way how the state/place is stored. If not defined "state_table" will be used as default. Take a look at the marking store section of the OpenDXP workflow docs for a description of the different types.
            marking_store:
            ...
            # Can be used to implement a special logic which subjects are supported by the workflow. For example only products matching certain criteria. Take a look at the support strategies page of the OpenDXP workflow docs for more details.
            support_strategy:
                ...
                arguments:
                    - \OpenDxp\Model\DataObject\Product
                    - subject.getProductType() == "article" and is_fully_authenticated() and "ROLE_OPENDXP_ADMIN" in role_names
            ...
            places:
                ...
                -
                    ...
                    # Nice name which will be used in the OpenDXP backend.
                    label:                ~

                    # Title/tooltip for this place when it is displayed in the header of the OpenDXP element detail view in the backend.
                    title:                ''

                    # Color of the place which will be used in the OpenDXP backend.
                    color:                '#bfdadc'

                    # If set to true the color will be used as border and font color otherwise as background color.
                    colorInverted:        false

                    # If set to false, the place will be hidden in the header of the OpenDXP element detail view in the backend.
                    ...
                    permissions:
                        ...
                        -
                            ...
                            # save permission as it can be configured in OpenDXP workplaces
                            save:                 ~

                            # publish permission as it can be configured in OpenDXP workplaces
                            publish:              ~

                            # unpublish permission as it can be configured in OpenDXP workplaces
                            unpublish:            ~

                            # delete permission as it can be configured in OpenDXP workplaces
                            delete:               ~

                            # rename permission as it can be configured in OpenDXP workplaces
                            rename:               ~

                            # view permission as it can be configured in OpenDXP workplaces
                            view:                 ~

                            # settings permission as it can be configured in OpenDXP workplaces
                            settings:             ~

                            # versions permission as it can be configured in OpenDXP workplaces
                            versions:             ~

                            # properties permission as it can be configured in OpenDXP workplaces
                            properties:           ~
            ...
            transitions:          # Required
                ...
                -
                    ...
                    options:
                        ...
                        # Nice name for the OpenDXP backend.
                        label:                ~
                        notes:
                            ...
                            additionalFields:
                                ...
                                -
                                    ...
                                    # Will be passed to the underlying OpenDXP data object field type. Can be used to configure the options of a select box for example.
                                    fieldTypeSettings:    []
                        ...
                        notificationSettings:
                            ...
                            -
                                ...
                                # Define which channel notification should be sent to, possible values "mail" and "opendxp_notification", default value is "mail".
                                channelType:
                                ...
                                # Type of mail source.
                                mailType:             template # One of "template"; "opendxp_document"

                                # Path to mail source - either Symfony path to template or fullpath to OpenDXP document. Optional use %_locale% as placeholder for language.
                                mailPath:             '@OpenDxpCore/Workflow/NotificationEmail/notificationEmail.html.twig'
