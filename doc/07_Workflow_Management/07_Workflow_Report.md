...
Since `single_state` (and others) stores the place information into data object attributes, OpenDXP default
object grids can be used to do workflow reporting on OpenDXP Objects. 
Just create a corresponding grid configuration and use default filtering and sorting functionality. 

Additionally extensions like [Advanced Object Search](https://github.com/open-dxp/advanced-object-search) can be used to 
