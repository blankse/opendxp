# Modifying OpenDXP Permissions Based On Workflow Places

As listed in the [configuration details section](./01_Configuration_Details/README.md) it's possible to modify the OpenDXP 
...
OpenDXP admins are allowed to publish and delete the object but for all other users it will be suppressed:
...
OpenDXP admins are allowed to modify (save, publish,...) the object but for all other users the save and delete button 
