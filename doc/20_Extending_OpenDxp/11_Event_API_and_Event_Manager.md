...
OpenDXP provides an extensive number of events that are fired during execution of OpenDXP functions. These events can be 
used to hook into many OpenDXP functions such as saving an object, asset or document and can be used to change or extend 
the default behavior of OpenDXP.
...
OpenDXP implements the standard Symfony framework event dispatcher and just adds some OpenDXP specific events, 
...
All OpenDXP events are defined and documented as a constant on component specific classes: 
- [Assets](https://github.com/open-dxp/opendxp/blob/1.x/lib/Event/AssetEvents.php)
- [Documents](https://github.com/open-dxp/opendxp/blob/1.x/lib/Event/DocumentEvents.php)
- [Data Objects](https://github.com/open-dxp/opendxp/blob/1.x/lib/Event/DataObjectEvents.php)
- [Versions](https://github.com/open-dxp/opendxp/blob/1.x/lib/Event/VersionEvents.php)
- [Data Object Class Definition](https://github.com/open-dxp/opendxp/blob/1.x/lib/Event/DataObjectClassDefinitionEvents.php)
- [Object Brick Definition](https://github.com/open-dxp/opendxp/blob/1.x/lib/Event/ObjectbrickDefinitionEvents.php)
- [Data Object Classification Store](https://github.com/open-dxp/opendxp/blob/1.x/lib/Event/DataObjectClassificationStoreEvents.php)
- [Data Object Custom Layouts](https://github.com/open-dxp/opendxp/blob/1.x/lib/Event/DataObjectCustomLayoutEvents.php)
- [Data Object Import](https://github.com/open-dxp/opendxp/blob/1.x/lib/Event/Model/DataObjectImportEvent.php)
- [Data Object Quantity Value Unit](https://github.com/open-dxp/opendxp/blob/1.x/lib/Event/DataObjectQuantityValueEvents.php)
- [Users / Roles](https://github.com/open-dxp/opendxp/blob/1.x/lib/Event/UserRoleEvents.php)
- [Workflows](https://github.com/open-dxp/opendxp/blob/1.x/lib/Event/WorkflowEvents.php)
- [Elements](https://github.com/open-dxp/opendxp/blob/1.x/lib/Event/ElementEvents.php)
...
- [Search](https://github.com/open-dxp/opendxp/blob/1.x/bundles/SimpleBackendSearchBundle/src/Event/SearchBackendEvents.php)
- [System](https://github.com/open-dxp/opendxp/blob/1.x/lib/Event/SystemEvents.php)
- [Tags](https://github.com/open-dxp/opendxp/blob/1.x/lib/Event/TagEvents.php)
- [Target Group](https://github.com/open-dxp/personalization-bundle/blob/1.x/src/Event/TargetGroupEvents.php)
- [Targeting](https://github.com/open-dxp/personalization-bundle/blob/1.x/src/Event/TargetingEvents.php)
- [Tests](https://github.com/open-dxp/opendxp/blob/1.x/lib/Event/TestEvents.php)
- [Translation](https://github.com/open-dxp/opendxp/blob/1.x/lib/Event/TranslationEvents.php)
- [Bundle Manager for injecting js/css files to OpenDXP backend or editmode](https://github.com/open-dxp/opendxp/blob/1.x/lib/Event/BundleManagerEvents.php)
...
services:
    App\EventListener\TestListener:
        tags:
            - { name: kernel.event_listener, event: opendxp.asset.preUpdate, method: onPreUpdate }
            - { name: kernel.event_listener, event: opendxp.document.preUpdate, method: onPreUpdate }
...
There are some global events having effect on several places. One of those is `opendxp.admin.object.list.beforeListLoad`.
The object list can be modified (changing condition for instance) before being loaded. This global event will apply to the tree, the grid list, the search panel and everywhere objects are listed in the OpenDXP GUI.
...
```php
    \OpenDxp::getEventDispatcher()->addListener(AdminEvents::RESOLVE_ELEMENT, function(ResolveElementEvent $event) {
        $id  = $event->getId();
...
The [AssetEvents::RESOLVE_UPLOAD_TARGET](https://github.com/open-dxp/opendxp/blob/1.x/lib/Event/AssetEvents.php) event
...
```php
        \OpenDxp::getEventDispatcher()->addListener(AssetEvents::RESOLVE_UPLOAD_TARGET,
            function(\OpenDxp\Event\Model\Asset\ResolveUploadTargetEvent $event) {
                ...
                if ($context["containerType"] == "object") {
                    ...
                    if ($newsObject) {
                        ...
                        $parent = \OpenDxp\Model\Asset\Service::createFolderByPath($targetPath);
                        if ($parent) {
