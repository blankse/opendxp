...
When building solutions with OpenDXP, normally one starts with configuring an object data model, 
create custom controller, actions and templates, creating documents and so on. Lots of things 
are possible without extending OpenDXP itself. 
But depending on the desired result, sometimes it is necessary to extend the default functionality
of OpenDXP. 

OpenDXP provides several ways for extension for that purpose. Depending on the use case one or the other
way may fit best. 
...
* Use [**Overriding Models**](./03_Overriding_Models.md) to overwrite OpenDXP default models. 

* [**Configuration**](../01_Getting_Started/04_Configuration.md) regarding configuration (e.g. overwriting OpenDXP constants
...
* [**Parent Class for Objects**](./07_Parent_Class_for_Objects.md) to inject additional functionality
 to OpenDXP object classes. 
 
* [**Event API and Event Manager**](../20_Extending_OpenDxp/11_Event_API_and_Event_Manager.md) for hooking into standard
 OpenDXP functions like creating, updating, deleting elements etc. 
...
* [**Create Bundles and OpenDXP Bundles**](13_Bundle_Developers_Guide/README.md) when you want to add complex and extensive functionalities to OpenDXP.
