...
OpenDXP provides a sophisticated thumbnail processing engine for calculating thumbnails based on source assets. So for 
different output channels OpenDXP can calculate and provide optimized images in terms of dimensions, file sizes, formats
and much more.

This functionality allows true single source publishing with OpenDXP.

### Allowed formats
OpenDXP allows the following formats for thumbnails out of the box:
