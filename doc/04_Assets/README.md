...
Assets are files that can be managed within the OpenDXP system which you can organize in folders. The most common assets 
are images. Other kinds of common assets are PDF or MS Word documents which people can download from the website.
OpenDXP is able to render preview images for most file types. 
