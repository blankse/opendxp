...
//getting assets
$asset1 = \OpenDxp\Model\Asset::getById(3456);
$asset2 = \OpenDxp\Model\Asset::getByPath("/my-assets/sample.png");
...
Asset Metadata allow you to attach localized metadata to assets within OpenDXP. These Medata can be accessed via API and
...
used as default `alt` and `title` attribute on any `<img>` tag generated by OpenDXP for the
corresponding image.

This includes for example:
```twig
// image editable on documents
{{ opendxp_image("myImage", {"thumbnail": "xyz"}) }}
```
