...
After installing a OpenDXP package you should see the folder structure described below.  
...
to your application) lives, such as the [production controller](https://github.com/open-dxp/skeleton/blob/1.x/public/index.php)
