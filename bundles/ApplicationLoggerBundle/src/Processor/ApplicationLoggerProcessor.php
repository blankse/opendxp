...
namespace OpenDxp\Bundle\ApplicationLoggerBundle\Processor;
    ...
    private function processFileObject(LogRecord $record): LogRecord
    {
        ...
        if (isset($context['fileObject'])) {
            if (is_string($context['fileObject'])) {
                $context['fileObject'] = str_replace(OPENDXP_PROJECT_ROOT, '', $context['fileObject']);
            } elseif ($context['fileObject'] instanceof FileObject) {
                $context['fileObject'] = str_replace(OPENDXP_PROJECT_ROOT, '', $context['fileObject']->getFilename());
            }
        }
