...
opendxp.registerNS('opendxp.bundle.search.element.selector.document');

/**
 * @private
 */
opendxp.bundle.search.element.selector.document = Class.create(opendxp.bundle.search.element.selector.abstract, {
    initStore: function () {
    ...
    getForm: function () {
        ...
        let possibleRestrictions = opendxp.globalmanager.get('document_search_types');
        let filterStore = [];
        let selectedStore = [];
                ...
                columns: [
                    {text: t("type"), width: 40, sortable: true, dataIndex: 'subtype',
                        renderer: function (value, metaData, record, rowIndex, colIndex, store) {
                            return '<div class="opendxp_icon_' + value + '" name="' + t(record.data.subtype) + '">&nbsp;</div>';
                        }
                    },
