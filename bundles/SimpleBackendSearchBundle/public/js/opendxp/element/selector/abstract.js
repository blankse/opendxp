...
opendxp.registerNS('opendxp.bundle.search.element.selector.abstract');

/**
 * @private
 */
opendxp.bundle.search.element.selector.abstract = Class.create({
    ...
    getTagsPanel: function() {
        if(!this.tagsPanel) {
            ...
            const tree = new opendxp.element.tag.tree();
    ...
    getPagingToolbar: function() {
        const pagingToolbar = opendxp.helpers.grid.buildDefaultPagingToolbar(this.store);
