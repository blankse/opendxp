...
opendxp.registerNS('opendxp.bundle.search.element.selector.asset');

/**
 * @private
 */
opendxp.bundle.search.element.selector.asset = Class.create(opendxp.bundle.search.element.selector.abstract, {
    initStore: function () {
    ...
    getForm: function () {
        ...
        let possibleRestrictions = opendxp.globalmanager.get('asset_search_types');
        let filterStore = [];
        let selectedStore = [];
                ...
                columns: [
                    {text: t("type"), width: 40, sortable: true, dataIndex: 'subtype', renderer:
                            function (value, metaData, record, rowIndex, colIndex, store) {
                                return '<div style="height: 16px;" class="opendxp_icon_asset opendxp_icon_' + value
            ...
            const columns = [
                {text: t("type"), width: 40, sortable: true, dataIndex: 'subtype',
                    renderer: function (value, metaData, record, rowIndex, colIndex, store) {
                        return '<div style="height: 16px;" class="opendxp_icon_'
                ...
                {text: t("preview"), width: 150, sortable: false, dataIndex: 'subtype',
                    renderer: function (value, metaData, record, rowIndex, colIndex, store) {
                        const routes = {
                            image: "opendxp_admin_asset_getimagethumbnail",
                            video: "opendxp_admin_asset_getvideothumbnail",
                            document: "opendxp_admin_asset_getdocumentthumbnail"
                        };
