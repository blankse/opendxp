...
opendxp.registerNS("opendxp.bundle.seo.seopanel");
/**
 * @private
 */
opendxp.bundle.seo.seopanel = Class.create({
    ...
    activate: function () {
        ...
        tabPanel.setActiveItem("opendxp_document_seopanel");
    },
    ...
    getTabPanel: function () {
        ...
        if (!this.panel) {
            this.panel = new Ext.Panel({
                id: "opendxp_document_seopanel",
                title: t("seo_document_editor"),
                iconCls: "opendxp_icon_document opendxp_icon_overlay_search",
                border: false,
                layout: "fit",
                closable:true,
                items: []
            ...
            this.panel.on("destroy", function () {
                opendxp.globalmanager.remove("bundle_seo_seo_seopanel");
            }.bind(this));

            opendxp.layout.refresh();

            Ext.Ajax.request({
                url: Routing.generate('opendxp_bundle_seo_document_document_seopaneltreeroot'),
    ...
    getTreeGrid: function (rootNodeConfig) {
        ...
        rootNodeConfig.iconCls = "opendxp_icon_home";
        ...
        var store = Ext.create('Ext.data.TreeStore', {
            proxy: {
                type: 'ajax',
                url: Routing.generate('opendxp_bundle_seo_document_document_seopaneltree')
            }
        });
    ...
    onRightClick: function (tree, record, item, index, e, eOpts ) {
        ...
        menu.add([{
            ...
            handler: opendxp.helpers.openDocument.bind(window, record.data.id, record.data.type)
        },{
            text: t('reload'),
