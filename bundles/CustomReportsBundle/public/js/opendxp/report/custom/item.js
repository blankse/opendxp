...
opendxp.registerNS("opendxp.bundle.customreports.custom.item");
/**
 * @private
 */
opendxp.bundle.customreports.custom.item = Class.create({
    ...
    addLayout: function () {
        ...
        this.panel = new Ext.Panel({
            region: "center",
            id: "opendxp_sql_panel_" + this.data.name,
            labelWidth: 150,
            autoScroll: true,
            border: false,
            items: [
    ...
    getAddControl: function () {
        ...
        if (this.currentElementCount < 1) {
            ...
            var definitionNames = Object.keys(opendxp.bundle.customreports.custom.definition);
    ...
    addSourceDefinition: function (sourceDefinitionData) {
        ...
        var adapter = new opendxp.bundle.customreports.custom.definition[sourceDefinitionData.type](sourceDefinitionData, key, this.getDeleteControl(t("custom_report_adapter_" + sourceDefinitionData.type, ucfirst(sourceDefinitionData.type)), key), this.getColumnSettings.bind(this));
    ...
    getColumnSettings: function () {
        ...
        Ext.Ajax.request({
            url: Routing.generate('opendxp_bundle_customreports_customreport_columnconfig'),
            method: "post",
            params: {
    ...
    save: function () {
        ...
        Ext.Ajax.request({
            url: Routing.generate('opendxp_bundle_customreports_customreport_update'),
            method: "PUT",
            params: {
