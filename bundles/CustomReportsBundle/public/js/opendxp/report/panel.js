...
opendxp.registerNS("opendxp.bundle.customreports.panel");
/**
 * @private
 */
opendxp.bundle.customreports.panel = Class.create({
    ...
    activate: function () {
        ...
        tabPanel.setActiveItem("opendxp_reports");
    },
    ...
    getLayout: function () {
        ...
        if (this.layout == null) {
            ...
            for (var i = 0; i < opendxp.bundle.customreports.broker.groups.length; i++) {

                group = opendxp.bundle.customreports.broker.groups[i];
                ...
                if (typeof opendxp.bundle.customreports.broker.reports[group.id] == "object") {
                    for (var r = 0; r < opendxp.bundle.customreports.broker.reports[group.id].length; r++) {
                        reportClass = opendxp.bundle.customreports.broker.reports[group.id][r]["class"];
                        try {
                            reportClass = stringToFunction(reportClass);
                            reportConfig = opendxp.bundle.customreports.broker.reports[group.id][r]["config"];
                            if (!reportConfig) {
                                reportConfig = {};
                            }
            ...
            var layoutConfig = {
                ...
                iconCls: "opendxp_material_icon_reports opendxp_material_icon"
            };

            // register an id for the standalone version
            if (this.type == "global") {
                layoutConfig.id = "opendxp_reports";
                layoutConfig.closable = true;
                layoutConfig["title"] = t('reports');
                layoutConfig["iconCls"] = 'opendxp_icon_reports';
            }
            ...
            if (this.type == "global") {
                ...
                this.layout.on("destroy", function () {
                    opendxp.globalmanager.remove("reports");
                }.bind(this));
