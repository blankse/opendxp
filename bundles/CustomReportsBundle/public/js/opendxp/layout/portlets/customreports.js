...
opendxp.registerNS("opendxp.layout.portlets.customreports");
/**
 * @private
 */
opendxp.layout.portlets.customreports = Class.create(opendxp.layout.portlets.abstract, {

    getType: function () {
        return "opendxp.layout.portlets.customreports";
    },
    ...
    editSettings: function () {
        this.configSelectionCombo = new Ext.form.ComboBox({
            xtype:"combo",
            width: 500,
            id: "opendxp_portlet_selected_custom_report",
            autoSelect: true,
            valueField: "id",
            displayField: "text",
            value: this.config,
            ...
            store: new Ext.data.Store({
                ...
                proxy: {
                    type: 'ajax',
                    url: Routing.generate('opendxp_bundle_customreports_customreport_portletreportlist'),
                    reader: {
                        type: 'json',
                        rootProperty: 'data'
                    }
    ...
    updateSettings: function() {
        this.config = Ext.getCmp("opendxp_portlet_selected_custom_report").getValue();
        Ext.Ajax.request({
            ...
            params: {
                ...
                config: Ext.getCmp("opendxp_portlet_selected_custom_report").getValue()
            },
            success: function () {
                this.updateChart();
            }.bind(this)
    ...
    getChart: function(data) {
        ...
        if(data.chartType == 'line' || data.chartType == 'bar') {
            ...
            var chartStore = new Ext.data.Store({
                ...
                proxy: {
                    type: 'ajax',
                    url: Routing.generate('opendxp_bundle_customreports_customreport_chart'),
                    extraParams: {
                        name: this.config
                    },
                    reader: {
            ...
            var chartStore = opendxp.helpers.grid.buildDefaultStore(
    ...
    openReport: function() {
        var reportClass = this.reportConfig.reportClass ? this.reportConfig.reportClass : "opendxp.bundle.customreports.custom.report";
