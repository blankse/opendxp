...
opendxp.registerNS("opendxp.bundle.xliff.settings");
/**
 * @private
 */
opendxp.bundle.xliff.settings = Class.create({
    ...
    activate: function () {
        ...
        tabPanel.setActiveItem("opendxp_xliff");
    },
    ...
    getTabPanel: function () {
        ...
        if (!this.panel) {
            ...
            this.panel.on("destroy", function () {
                opendxp.globalmanager.remove("bundle_xliff");
            }.bind(this));
    ...
    getExportPanel: function () {
        ...
        let modelName = 'opendxp.model.xliff.store';
    ...
    startExport: function () {
        ...
        Ext.Ajax.request({
            ...
            params: {
                ...
                type: "xliff",
                job_url: Routing.generate('opendxp_bundle_xliff_translation_xliffexport')
            },
            success: function(response) {
                ...
                var pj = new opendxp.tool.paralleljobs({
                    success: function (id) {
                        ...
                        opendxp.helpers.download(Routing.generate('opendxp_bundle_xliff_translation_exportdownload', {id: id}));
                    }.bind(this, res.id),
    ...
    getImportPanel: function () {
        this.importPanel = new Ext.Panel({
            ...
            buttons: [{
                ...
                iconCls: "opendxp_icon_file opendxp_icon_overlay_add",
                handler: function () {
                    opendxp.helpers.uploadDialog(Routing.generate('opendxp_bundle_xliff_translation_xliffimportupload'), "file", function(res) {
