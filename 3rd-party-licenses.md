...
The OpenDXP project is licensed under the terms of the [GPLv3](LICENSE.md).

However, OpenDXP includes several third-party Open-Source libraries, 
which are licensed under their own respective Open-Source licenses.

The specific verions of a library are documented in
[OPENDXP_MODIFICATIONS.md](bundles/AdminBundle/public/js/lib/OPENDXP_MODIFICATIONS.md).

## Libraries directly included in OpenDXP

### ExtJS by Sencha Inc.
License: GPLv3  
OpenDXP includes the GPLv3 version of the ExtJS JavaScript framework.  
